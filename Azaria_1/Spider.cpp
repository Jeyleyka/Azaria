...
void Spider::InitAnimations()
{
	...
	this->animationComponent->AddAnimation("WALK_DOWN", 11.f, 0, 0, 3, 0, 60, 64);
	this->animationComponent->AddAnimation("WALK_LEFT", 11.f, 0, 1, 3, 1, 60, 64);
	this->animationComponent->AddAnimation("WALK_RIGHT", 11.f, 0, 2, 3, 2, 60, 64);
	this->animationComponent->AddAnimation("WALK_UP", 11.f, 0, 3, 3, 3, 60, 64);
...
void Spider::Render(sf::RenderTarget& target, sf::Shader* shader, const sf::Vector2f light_position)
{
	if (shader)
	{
